...
def transform_and_anonymize_data(ti):
    cleaned_data = ti.xcom_pull(task_ids='extract_and_transform_data')
    anonymized_data = anonymize_column(cleaned_data)
...
with dag:
    ...
    task_validate >> task_extract_and_transform >> task_anonymize >> task_load
